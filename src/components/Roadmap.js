  ...
  return (
    <section className="roadmap">
      <div className="container-fluid">
        <h1 className="roadmap-title">2048 <span>ROADMAP</span></h1>
        <div className="row">
              ...
              <div className="card-body">
                {activeItem === 'NEW NFTS' && (
                  <>
                    ...
                    <hr />
                    <ul>
                      <li><i className="bi bi-check-circle"></i> Basic game</li>
                      <li><i className="bi bi-check-circle"></i> Referral system</li>
                      <li><i className="bi bi-check-circle"></i> LVL ratings</li>
                    </ul>
                  </>
                )}
                {activeItem === 'WHITELIST MINTING' && (
                  <>
                    ...
                    <hr />
                    <ul>
                      <li><i className="bi bi-check-circle"></i> Roadmaps game</li>
                      <li><i className="bi bi-check-circle"></i> Grow community</li>
                      <li><i className="bi bi-check-circle"></i> Earn tasks</li>
                    </ul>
                  </>
                )}
